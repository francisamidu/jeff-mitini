...
export default function ServicesSection() {
  return (
    <section id="request">
      <div className="w-full px-7 py-16 md:py-24 bg-gradient-to-b from-white to-slate-50">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center p-8 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all duration-300 group h-full">
              ...
              <p className="mb-8 text-center text-slate-600">
                Looking for a BI Developer with expertise in SQL, Python,
                Tableau, and Power BI? I specialize in designing and deploying
                BI solutions that drive business outcomes.
              </p>
            ...
            <div className="flex flex-col items-center text-center p-8 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all duration-300 group h-full">
              ...
              <p className="mb-8 text-center text-slate-600">
                Need help with data analysis, visualization, or BI
                implementation? I offer consulting services in dashboard
                development, statistical analysis, and AWS cloud solutions.
              </p>
              <div className="mt-auto">
                <Button className="bg-slate-800 hover:bg-slate-900 text-white group-hover:translate-y-[-2px] transition-transform duration-300 flex items-center gap-2">
                  Consulting Request
            ...
            <div className="flex flex-col items-center text-center p-8 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all duration-300 group h-full">
              ...
              <p className="mb-8 text-center text-slate-600">
                Interested in collaborating on data-driven projects? Let's
                partner on developing innovative BI solutions, research
                projects, or data analysis initiatives that deliver measurable
                results.
              </p>
              <div className="mt-auto">
                <Button className="bg-slate-800 hover:bg-slate-900 text-white group-hover:translate-y-[-2px] transition-transform duration-300 flex items-center gap-2">
